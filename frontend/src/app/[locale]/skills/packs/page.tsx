  ...
  return (
    <>
      <DashboardPageLayout
        ...
        title={t("title")}
        description={t("description", { count: packs.length, plural: packs.length === 1 ? "" : "s" })}
        headerActions={
          isAdmin ? (
            <div className="flex items-center gap-2">
              ...
              >
                {isSyncingAll ? t("syncingAll") : t("syncAll")}
              </button>
              <Link
        ...
        <div className="space-y-6">
          <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            <SkillPacksTable
              ...
              emptyState={{
                title: t("noPacks"),
                description: t("noPacksDescription"),
                actionHref: "/skills/packs/new",
                actionLabel: t("addFirstPack"),
              }}
            />
          </div>
